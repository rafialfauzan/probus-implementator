    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[28px] shadow-md card w-full">
                <div class="card-body">
                                <h1 class="card-title text-3xl font-extrabold mb-4">Edit Request</h1>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div class="flex flex-col space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="input rounded-xl input-bordered w-full" value="{{ $req->judul }}" name="title" placeholder="Enter request title...">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <input type="date" class="input input-bordered rounded-xl w-full border-gray-300" value="{{ $req->start_date }}" name="startdate" required>
                                                    <span class="font-bold text-gray-500 px-1">TO</span>
                                                    <input type="date" class="input input-bordered rounded-xl w-full border-gray-300" value="{{ $req->end_date }}" name="enddate" required>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input name="images[]" type="file" multiple class="file-input file-input-bordered w-full rounded-xl">
                                                ...
                                                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-3">
                                                    ...
                                                    <div class="h-[120px] relative border shadow-sm overflow-hidden rounded-xl group">
                                                        <a onclick="return confirm('Are you sure you want to delete this data?')" href="/deleteimg/{{ $image->id }}" class="btn btn-error btn-xs text-white rounded-lg absolute top-2 right-2 z-10">✕</a>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="flex-1 flex flex-col">
                                                <trix-editor toolbar="trix-toolbar-edit" trix-attachment-remove input="body" class="bg-white rounded-xl border border-gray-300 p-3 min-h-[380px] flex-1 focus:outline-none"></trix-editor>
                                            </div>
                                        </div>
                                    </div>
